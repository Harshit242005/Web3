# code for voding the party we would pass the details and call for the voting
...
def uploadValuesForVote(privatekey, accountAddress, Name, Email, PhoneNumber, Age, Gender, Location, PartyName):
    global private_key, account_address, name, email, phoneNumber, age, gender, location, partyName
...
def voteParty(voteParty):
        gas_estimate_vote = contract.functions.voteParty(
            name,
            email,
            phoneNumber,
            age,
        ...
        transaction_vote = contract.functions.voteParty(
            name,
            email,
            phoneNumber,
            age,
