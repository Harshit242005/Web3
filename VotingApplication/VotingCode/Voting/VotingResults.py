...
def upload_values_for_result_show(Accout, PrivateKey):
    global private_key, account_address
    account_address = Accout
...
def ShowResult():
    result = contract.functions.getElectionResult().call({'from': account_address})
    return result
